...
export function Navbar() {
  return (
    <>
      ...
      <nav className="fixed top-2 left-1/2 -translate-x-1/2 z-40 backdrop-blur-lg bg-white/70 border border-white/30 rounded-3xl shadow-md px-6 py-3 my-6 mx-auto flex items-center justify-between gap-4 hidden md:flex w-[55vw] max-w-[410px] ">
