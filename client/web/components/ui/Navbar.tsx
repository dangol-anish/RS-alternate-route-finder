...
export function Navbar() {
  return (
    <>
      ...
      <nav className="fixed top-2 left-1/2 -translate-x-1/2 z-40 backdrop-blur-lg bg-white/70 border border-white/30 rounded-3xl shadow-md px-6 py-3 my-6 mx-auto  items-center justify-between gap-4 hidden md:flex w-[55vw] max-w-[410px] ">
      ...
      <SidebarProvider defaultOpen={false}>
        <SidebarTrigger className="fixed top-4 right-4 z-50 w-10 h-10 bg-[var(--green)]/40 text-[var(--brown)] hover:text-[var(--light-brown)] cursor-pointer shadow-lg rounded-2xl flex items-center justify-center backdrop-blur-lg hover:bg-[var(--beige)]/80 transition-colors duration-200 lg:hidden" />
        <Sidebar
          variant="sidebar"
