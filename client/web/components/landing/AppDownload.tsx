...
const AppDownload = () => {
  return (
    <section className="min-h-screen flex flex-col relative py-20 overflow-hidden bg-gradient-to-b from-white to-[var(--beige)]">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[75vh] bg-[var(--light-green)]/60 rounded-b-[200px] z-10"></div>

      <div className="flex-1 flex flex-col justify-center items-center w-[90%] max-w-6xl mx-auto z-11">
        <div className="flex flex-col gap-4">
          <h2 className="text-5xl md:text-5xl font-extrabold text-center text-[var(--brown)] bg-clip-text mb-6">
            Download <span className="text-[var(--green)]">Road</span>Sense now
            and never get stuck in traffic again.
          </h2>
