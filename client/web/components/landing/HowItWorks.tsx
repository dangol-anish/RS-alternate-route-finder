   ...
   text-[var(--brown)] 
    ...
    "
            ...
            <p className="text-center text-[var(--brown)] text-xl font-light">
              Make smarter travel choices and skip the roadblocks with RS
              Alternate Route Finder - just follow these easy steps.
            </p>
          </div>
          <div className="flex flex-col gap-12 mt-24">
            {steps.map((step, idx) => (
              <AnimateInView key={step.title} delay={0.1 + idx * 0.15}>
                <div
